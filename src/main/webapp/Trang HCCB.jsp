...
<head>
  ...
  <style>
    ...
    .btn-type button.active {
      background: #1e90ff;
      color: #000; /* Đổi màu chữ khi active */
...
<div class="products">
  ...
  <div class="sidebar">
    ...
    <div class="arrange">
      <ul id="sort">
        ...
        <li class="price "><a href="Trang HCCB_Lọc theo giá.jsp">Giá</a></li>
        <li class="volume"><a href="list3.html">Thể tích</a></li>
      </ul>
    </div>
    <a href="Trang Khuyến mãi.jsp"><img src="img/Sale hóa chất.gif" alt=""></a>
    <div class="hot-info">
      <div class="hot-item">
  ...
  <div class="main-content">
    ...
    <div class="sort-by">
      <div class="btn-type">
        <button class="btn-axit ">AXIT</button>
    ...
    <div class="product-lists">
      ...
      <a href="#">
        <div class="product-item">
          <img src="https://hoachatthinghiem.org/wp-content/uploads/2021/12/Thiamine-HCL-247x247.jpg"
               alt="">
          <ul class="content">
            <li class="product-name">Thiamine hydrochloride (Vitamin B1, ≥99.0% TQ)</li>
